  ...
  return (
    <div className='loginsignup'>
      <div className="loginsignup-container">
        ...
        {state==="Sign Up"?<p className="loginsignup-login">Already have an account <span onClick={()=>{setState("Login")}}>Login here</span></p>:<p className="loginsignup-login">Need an account <span onClick={()=>{setState("Sign Up")}}>Click here</span></p>}
